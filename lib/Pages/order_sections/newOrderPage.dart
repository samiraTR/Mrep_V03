...
class _NewOrderPageState extends State<NewOrderPage> {
  ...
  var formatter = NumberFormat('#,##0.' + "#" * 10);
...
//     }
    ...
    if (itemString != '') {
      ...
      try {
        ...
        print("$submit_url+api_order_submit/submit_data?cid=$cid&user_id=$userId&user_pass=$userPassword&client_id=${widget.clientId}&delivery_date=$dateSelected&delivery_time=$selectedDeliveryTime&pay_mode=$slectedPayMethod&item_list=$itemString&location_detail=$address");
